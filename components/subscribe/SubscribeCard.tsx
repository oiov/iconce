...
export default function SubscribeCard({ id, info, clickButton }: IProps) {
  return (
    <div
      id={id}
      className={clsxm(
        "flex flex-col p-6 bg-[#1f2023] shadow-lg rounded-lg justify-between border border-gray-700/50",
      ...
      <div>
        ...
        <div className="text-center text-zinc-400">{info.description}</div>
